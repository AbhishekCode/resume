...
var PageOneContent = React.createClass({
  ...
  render: function() {
    return React.DOM.div(null,
      ...
      React.DOM.li(null,'2+ years of experience as Games Developer for Android, iOS and web platform.'),
      React.DOM.li(null,'Experience with Unity3d, Impactjs Game Engines.'),
      ...
      React.DOM.li(null,'Knowledge of Software Development Life Cycle with new practices like Agile(Scrum).'),
      React.DOM.li(null,'Knowledge of Web Development technologies like HTML, JS, CSS, jQuery.'),
...
var PageTwoContent = React.createClass({
  ...
  render: function() {
    return React.DOM.div(null,
        ...
        React.DOM.h4(null, 'BYOF Studios', React.DOM.code(null, ' (Game Developer: January 2015-Present)')),
